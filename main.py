...
def register():
    ...
    if form.validate_on_submit():
        ...
        hashed_pass = generate_password_hash(unhashed_pass,method="pbkdf2:sha256",salt_length=8)
...
def contact():
    ...
    return render_template("contact.html", msg_sent=request.args.get("msg_sent"))
